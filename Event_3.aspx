                    ...
                    <tr>
                        <td style="text-align: left;">
                          <p>
                            ...
                            <img class="displayed" src=".\Images\Event_11.png" alt="E11" />
                            <br /> <br /><br />
                           ...
                           <p> Herrscher of Finality is an S-rank Herrscher battlesuit for Kiana Kaslana. She is an IMG-type Fire DMG dealer who attacks with pistols and a sword.<br />
                            ...
                            <img class="displayed" src=".\Images\skill_5.gif" alt="SK5" />
                            <p><br />
                            ...
                            <img class="displayed" src=".\Images\skill_8.gif" alt="SK8" />
                            <p><br />
                            ...
                            <img class="displayed" src=".\Images\skill_6.gif" alt="SK6" /><br /><br />
                            <img class="displayed" src=".\Images\skill_3.gif" alt="SK3" />
                             <p><br />
                            ...
                            <img class="displayed" src=".\Images\skill_2.gif" alt="SK2" />
                            <p>
                            ...
                            <img class="displayed" src=".\Images\skill_7.gif" alt="SK7" />
                            <p><br /><br />
                            ...
                            <img class="displayed" src=".\Images\skill_4.gif" alt="SK4" />
                            <p><br />
                            ...
                            <img class="displayed" src=".\Images\skill_1.gif" alt="SK1" />
                            <p><br /> 
                            ...
                            <img class="displayed" src=".\Images\Event_10.png" alt="BS" />
                            </p><br /> 
                            <p style="color:darkorange;">※※※※※ New ELF Kiana Kaslana ※※※※※<br /></p>
                            She's the new addition to the ELF lineup.<br />
                            <img class="displayed" src=".\Images\Event_12.png" alt="E12" />
