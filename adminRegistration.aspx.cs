...
namespace DURANDAL_IO
{
    public partial class adminRegistration : System.Web.UI.Page
    {
        ...
        {
            if ((!string.IsNullOrEmpty(username.Text)) && (!string.IsNullOrEmpty(pwd.Text)) && (!string.IsNullOrEmpty(fname.Text)) && (!string.IsNullOrEmpty(lname.Text)) && (!string.IsNullOrEmpty(country.Text))
                  && (!string.IsNullOrEmpty(email.Text)) && (!string.IsNullOrEmpty(username.Text)) && (!string.IsNullOrEmpty(pwd.Text)) && (!string.IsNullOrEmpty(usertype.Text)))
            {
                try
                {
            ...
            else
            {
                errMsg.Visible = true;
                errMsg.ForeColor = System.Drawing.Color.Red;
                errMsg.Text = "Please Type In Any Input Before Submitting";
                return;
            }
        }
    }
